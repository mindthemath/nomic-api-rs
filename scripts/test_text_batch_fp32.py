...
def main():
    ...
    if len(results) == 2:
        ...
        print(
            f"{'Max diff (same len, no pad)':<40} {q['max_diff_same_len']:<20.6f} {f['max_diff_same_len']:<20.6f} {abs(q['max_diff_same_len'] - f['max_diff_same_len']):<15.6f}"
        )
        print(
            f"{'Max diff (different len)':<40} {q['max_diff_different']:<20.6f} {f['max_diff_different']:<20.6f} {abs(q['max_diff_different'] - f['max_diff_different']):<15.6f}"
        )
        print(
            f"{'Max diff (image 1)':<40} {q['max_diff_1']:<20.6f} {f['max_diff_1']:<20.6f} {abs(q['max_diff_1'] - f['max_diff_1']):<15.6f}"
        )
        print(
            f"{'Max diff (image 2)':<40} {q['max_diff_2']:<20.6f} {f['max_diff_2']:<20.6f} {abs(q['max_diff_2'] - f['max_diff_2']):<15.6f}"
        )
        print(
            f"{'Cosine sim (text 1)':<40} {q['cos_sim_1']:<20.6f} {f['cos_sim_1']:<20.6f} {abs(q['cos_sim_1'] - f['cos_sim_1']):<15.6f}"
        )
        print(
            f"{'Cosine sim (text 2)':<40} {q['cos_sim_2']:<20.6f} {f['cos_sim_2']:<20.6f} {abs(q['cos_sim_2'] - f['cos_sim_2']):<15.6f}"
        )
