...
def main():
    ...
    if len(results) == 2:
        ...
        print(f"{'Max diff (image 1)':<30} {q['max_diff_1']:<20.6f} {f['max_diff_1']:<20.6f} {abs(q['max_diff_1'] - f['max_diff_1']):<15.6f}")
        print(f"{'Max diff (image 2)':<30} {q['max_diff_2']:<20.6f} {f['max_diff_2']:<20.6f} {abs(q['max_diff_2'] - f['max_diff_2']):<15.6f}")
        print(f"{'Mean diff (image 1)':<30} {q['mean_diff_1']:<20.6f} {f['mean_diff_1']:<20.6f} {abs(q['mean_diff_1'] - f['mean_diff_1']):<15.6f}")
        print(f"{'Mean diff (image 2)':<30} {q['mean_diff_2']:<20.6f} {f['mean_diff_2']:<20.6f} {abs(q['mean_diff_2'] - f['mean_diff_2']):<15.6f}")
        print(f"{'Cosine sim (image 1)':<30} {q['cos_sim_1']:<20.6f} {f['cos_sim_1']:<20.6f} {abs(q['cos_sim_1'] - f['cos_sim_1']):<15.6f}")
        print(f"{'Cosine sim (image 2)':<30} {q['cos_sim_2']:<20.6f} {f['cos_sim_2']:<20.6f} {abs(q['cos_sim_2'] - f['cos_sim_2']):<15.6f}")
        print(f"{'L2 distance (image 1)':<30} {q['l2_dist_1']:<20.6f} {f['l2_dist_1']:<20.6f} {abs(q['l2_dist_1'] - f['l2_dist_1']):<15.6f}")
        print(f"{'L2 distance (image 2)':<30} {q['l2_dist_2']:<20.6f} {f['l2_dist_2']:<20.6f} {abs(q['l2_dist_2'] - f['l2_dist_2']):<15.6f}")
        ...
        print(f"  Cosine sim (image 1): {r['cos_sim_1']:.6f} ({r['cos_sim_1']*100:.2f}%)")
        print(f"  Cosine sim (image 2): {r['cos_sim_2']:.6f} ({r['cos_sim_2']*100:.2f}%)")
